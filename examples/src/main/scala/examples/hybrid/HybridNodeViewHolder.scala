...
import examples.commons.{Nonce, PublicKey25519NoncedBox, SimpleBoxTransaction, SimpleBoxTransactionCompanion, TreasuryMemPool, Value, _}
...
object HybridNodeViewHolder extends ScorexLogging {
  ...
  def generateGenesisState(settings: ScorexSettings, minerSettings: HybridMiningSettings, timeProvider: NetworkTimeProvider):
                          (HybridHistory, HBoxStoredState, HWallet, TreasuryMemPool) = {
