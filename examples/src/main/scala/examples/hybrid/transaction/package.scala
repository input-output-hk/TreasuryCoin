...
package object transaction {
  ...
  val DKGr1TxTypeId: scorex.core.ModifierTypeId = scorex.core.ModifierTypeId @@ 64.toByte
  val DKGr2TxTypeId: scorex.core.ModifierTypeId = scorex.core.ModifierTypeId @@ 65.toByte
  val DKGr3TxTypeId: scorex.core.ModifierTypeId = scorex.core.ModifierTypeId @@ 66.toByte
